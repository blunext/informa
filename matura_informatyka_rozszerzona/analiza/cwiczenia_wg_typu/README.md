...
Zestaw cwiczen oparty na analizie 11 lat matur z informatyki rozszerzonej (2014-2025).
Kazdy typ zadania ma 5 cwiczen o roznej trudnosci.

## Jak korzystac

1. Przeczytaj tresc cwiczenia
2. Rozwiaz samodzielnie na kartce lub w edytorze
3. Kliknij "Odpowiedz" aby sprawdzic rozwiazanie
4. Przeanalizuj rozwiazanie krok po kroku

## Legenda trudnosci

| Poziom | Opis | Czas |
|--------|------|------|
| latwe | Rozgrzewka, budowanie pewnosci siebie | 3-5 min |
| srednie | Typowy poziom maturalny | 5-10 min |
| trudne | Rozszerzenie, wyzszy poziom | 10-20 min |

Rozklad w kazdym pliku: 2 latwe + 2 srednie + 1 trudne.

## Etap 1: TEORIA (6 typow, 30 cwiczen)

| Nr | Plik | Typ zadania | Cwiczen | Punkty na maturach | Czestotliwosc |
|----|------|-------------|---------|---------------------|---------------|
| 01 | [01_sledzenie_algorytmu.md](01_sledzenie_algorytmu.md) | sledzenie_algorytmu | 5 | 45 pkt | 11/11 lat |
| 02 | [02_projektowanie_algorytmu.md](02_projektowanie_algorytmu.md) | projektowanie_algorytmu | 5 | 43 pkt | 11/11 lat |
| 03 | [03_analiza_algorytmu.md](03_analiza_algorytmu.md) | analiza_algorytmu | 5 | 37 pkt | 10/11 lat |
| 04 | [04_test_prawda_falsz.md](04_test_prawda_falsz.md) | test_prawda_falsz | 5 | 25 pkt | 10/11 lat |
